// Core saturation sweep — smaller 16x64 tile, K=16
// Config C: 128 threads, small tile — 4x more threadgroups than config B

#include <metal_stdlib>
using namespace metal;

kernel void gemm_small_tile(
